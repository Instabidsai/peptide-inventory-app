...
import { Plus, ArrowLeftRight, Trash2, Eye } from 'lucide-react';
        ...
        <CardContent className="pt-6">
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mb-4">Record your first inventory movement</p>
              <Button asChild>
                <Link to="/movements/new">Record Movement</Link>
              </Button>
            </div>
          ) : (
            <Table>
