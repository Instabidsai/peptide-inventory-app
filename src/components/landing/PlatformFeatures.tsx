...
export function PlatformFeatures() {
  const categories = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      features: [
        { icon: Users, title: "3-Tier Partner Program", desc: "Senior (2x cost), Standard (2x cost, 10% commission), Referral (20% off retail). Per-person recruitment and pricing overrides. Automated tier management." },
