...
export function PlatformFeatures() {
  const categories = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      features: [
        { icon: Users, title: "3-Tier Partner Program", desc: "Senior, Standard, and Referral tiers with custom pricing per partner. Per-person recruitment and pricing overrides. Automated tier management." },
