        ...
        dosingTiers: [
            {
                ...
                frequency: 'daily',
                timing: 'AM',
                notes: 'Starting dose for gut inflammation. 200 mcg daily subcutaneous. Can also be taken orally in capsule form for direct gut lining contact. Assess for 2 weeks before increasing.',
        ...
        dosingTiers: [
            {
                ...
                frequency: 'daily',
                timing: 'AM',
                notes: '250 mcg daily on an empty stomach. Gut-targeted healing. Take 30 minutes before food for best absorption.',
                cyclePattern: '4\u20138 weeks on, 2 weeks off.',
            },
            {
                id: 'standard',
                label: 'Standard Gut Protocol',
                doseAmount: 500,
                doseUnit: 'mcg',
                frequency: 'daily',
                timing: 'AM',
                notes: '500 mcg daily on an empty stomach. Primary route for GI issues (IBS, leaky gut, gastritis). Oral BPC-157 directly contacts the gut lining for localized healing. Take with minimal water.',
                cyclePattern: '4\u20138 weeks on, 2 weeks off.',
            },
            {
                id: 'aggressive',
                label: 'Twice Daily (Active Gut Healing)',
                doseAmount: 500,
                doseUnit: 'mcg',
                frequency: 'twice daily',
                timing: 'AM',
                notes: '500 mcg morning + 500 mcg evening (1 mg total daily). For active gut inflammation, gastric ulcers, or IBD support. Take each dose on an empty stomach, 30 min before meals.',
                dosageSchedule: 'Morning: 500 mcg oral (empty stomach)\nEvening: 500 mcg oral (empty stomach)\nTotal: 1 mg daily',
                cyclePattern: '6\u20138 weeks, then reassess.',
            },
        ],
    },
    'Hexarelin': {
...
export const PROTOCOL_TEMPLATES: ProtocolTemplate[] = [
    ...
    {
        name: 'Gut Healing',
        description: 'BPC-157 (Oral) + KPV for gut lining repair and inflammation',
        category: 'healing',
        icon: 'Heart',
        peptideNames: ['Pentadecapeptide BPC-157 (Oral)', 'KPV'],
    },
    {
        name: 'Immune Boost',
